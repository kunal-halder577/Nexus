...
export const baseApi = createApi({
  ...
  tagTypes: ["User", "Post", "Comment", "Notification", 'Followers', 'Following', 'FollowStatus', "PostLikers", "CommentLikers", "LikedContent", "admin-dashboard", "admin-audit-logs", "admin-users"],
  endpoints: () => ({}),
});